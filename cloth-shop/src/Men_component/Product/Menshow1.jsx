...
const reviews = { href: '#', average: 4, totalCount: 54 }
...
function Menshow1() {
  ...
  useEffect(() => {
    ...
    {
      selectedItem ?
        setSelectedColor(selectedItem.colors[1]) && setSelectedSize(selectedItem.sizes[1])
        :
        null
    }
  }, [id])
  ...
  const addhandler = () => {
    const selectedProduct = menData.find(item => item.id === parseInt(id));
